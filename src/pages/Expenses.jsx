...
const Expenses = () => {
  ...
  const handleExport = (type) => {
    ...
    if (type === 'excel') {
      exportToExcel(filteredExpenses, columns, title, dateLabel, 'Beinnovo EIMS');
    } else {
      exportToPDF(filteredExpenses, columns, title, dateLabel, 'Beinnovo EIMS', theme.palette.primary.main);
    }
  };
