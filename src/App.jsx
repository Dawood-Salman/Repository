...
const SuperAdminDashboard = lazy(() => lazyRetry(() => import('./pages/SuperAdminDashboard')));
const StudentDashboard = lazy(() => lazyRetry(() => import('./pages/StudentDashboard')));
const TeacherDashboard = lazy(() => lazyRetry(() => import('./pages/TeacherDashboard')));
        ...
        <Router>
          <Suspense fallback={<LoadingFallback />}>
            <Routes>
              ...
              <Route path="/student/*" element={<PrivateRoute requireRole="student"><StudentDashboard /></PrivateRoute>} />
              <Route path="/teacher/*" element={<PrivateRoute requireRole="teacher"><TeacherDashboard /></PrivateRoute>} />
              <Route path="/company/:companyId/*" element={<PrivateRoute><Dashboard /></PrivateRoute>} />
              <Route path="/superadmin/*" element={<PrivateRoute requireRole="superadmin"><SuperAdminDashboard /></PrivateRoute>} />
              <Route path="*" element={<RootRedirect />} />
            </Routes>
          </Suspense>
        </Router>
