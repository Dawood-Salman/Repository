...
const addExcelHeader = (worksheet, title, dateRange, companyName, themeColor = '2E7D32') => {
    ...
    companyCell.value = companyName || 'Beinnovo EIMS';
...
export const exportToExcel = async (data, columns, title, dateRange, companyName, themeColor = '2E7D32', summaryData = null) => {
    ...
    footerCell.value = `Report generated by Beinnovo EIMS on ${moment().format('DD MMM YYYY [at] HH:mm')}`;
...
export const exportToPDF = (data, columns, title, dateRange, companyName, themeColor = '2E7D32', summaryData = null) => {
    ...
    doc.text(companyName || 'Beinnovo EIMS', pageWidth / 2, 15, { align: 'center' });
    ...
    doc.text(
        `Report generated by Beinnovo EIMS on ${moment().format('DD MMM YYYY [at] HH:mm')}`, 
        pageWidth / 2, 
        pageHeight - 10, 
        { align: 'center' }
    );
