...
// ── Beinnovo Official Brand Colors (from logo) ────────────────────────────────
const primaryBlue      = '#1055B8';  // Brand deep royal blue (B letter base)
const primaryBlueLight = '#42A5F5';  // Brand bright blue (B letter highlight)
const primaryBlueDark  = '#0D47A1';  // Brand darkest blue (B letter shadow)
const accentGold       = '#F5A623';  // Brand gold (ascending bars in logo)
const accentGoldDark   = '#E65100';  // Brand gold deep (bar base)
const textPrimary      = '#0F172A';  // Near-black
const textSecondary    = '#64748B';  // Slate 500
const bgDefault        = '#F4F7FF';  // Light blue-tint background
const bgPaper          = '#FFFFFF';  // White
const borderColor      = '#E2E8F0';  // Slate 200
const successGreen     = '#10B981';  // Emerald 500
const errorRed         = '#EF4444';  // Red 500
const warningAmber     = '#F5A623';  // Brand gold used as warning
