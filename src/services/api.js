...
export const fetchAllSchools = () => API.get('/companies');
export const createSchool = (schoolData) => API.post('/companies', schoolData);
export const toggleSchoolStatus = (id) => API.put(`/companies/${id}/toggle`);
export const deleteSchool = (id) => API.delete(`/companies/${id}`);
export const fetchSchoolAdmin = (id) => API.get(`/companies/${id}/admin`);
...
export const bulkUploadStudents = (companyId, file) => {
    const formData = new FormData();
    formData.append('file', file);
    return API.post(`/students/bulk-upload/${companyId}`, formData, {
        headers: { 'Content-Type': 'multipart/form-data' }
    });
};

// Student dashboard diary
export const fetchStudentDiary = () => API.get('/student-dashboard/diary');
export const createStudentDiaryEntry = (entry) => API.post('/student-dashboard/diary', entry);
export const updateStudentDiaryEntry = (id, entry) => API.put(`/student-dashboard/diary/${id}`, entry);
export const deleteStudentDiaryEntry = (id) => API.delete(`/student-dashboard/diary/${id}`);

export const fetchStudentNotifications = () => API.get('/notifications/student');
export const markStudentNotificationRead = (notificationId) => API.put(`/notifications/${notificationId}/read`);
export const sendNotification = (payload) => API.post('/notifications', payload);
export const fetchAdminNotifications = (companyId) => API.get(`/notifications/company/${companyId}`);
...
export const bulkUploadTeachers = (companyId, file) => {
    const formData = new FormData();
    formData.append('file', file);
    return API.post(`/teachers/bulk-upload/${companyId}`, formData, {
        headers: { 'Content-Type': 'multipart/form-data' }
    });
};
...
// ── Student Dashboard ─────────────────────────────────────────────────────────────
export const getStudentProfile = () => API.get('/student-dashboard/profile');
export const getStudentFees = () => API.get('/student-dashboard/fees');
export const getStudentAttendance = (params = {}) => API.get('/student-dashboard/attendance', { params });
export const updateStudentProfile = (data) => API.put('/student-dashboard/profile', data);

// ── Teacher Dashboard ─────────────────────────────────────────────────────────────
export const getTeacherProfile = () => API.get('/teacher-dashboard/profile');
